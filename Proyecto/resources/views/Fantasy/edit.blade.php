...
function resetAPModal() {
	...
	for(var j=0; j <= 2; j++) {
		...
		$('#question' + j + '_ap_question_type').attr("selectedIndex",0);
		$('#question' + j + '_ap_question_text').attr("value","");
		$('#question' + j + '_ap_question_score').attr("value","");

		$('#question' + j + '_ap_type0').show();
		$('#question' + j + '_ap_type1').hide();
		$('#question' + j + '_ap_type2').hide();

		$('#question' + j + '_ap_answer_correct').attr("value","");
		$('#question' + j + '_ap_answer_incorrect0').attr("value","");
		$('#question' + j + '_ap_answer_incorrect1').attr("value","");
		$('#question' + j + '_ap_answer_incorrect2').attr("value","");

		$('#question' + j + '_ap_answer0').attr("value","");
		$('#question' + j + '_ap_answer1').attr("value","");
		$('#question' + j + '_ap_answer2').attr("value","");
		$('#question' + j + '_ap_answer3').attr("value","");
		...
		$('#question' + j + '_ap_gapword').attr("value","");
	...
	// Ajax to get quiz data
		...
		if(data){ // Show the correct fields with their respective values
			...
			for (var j=0; j < questions.length; ++j) {
				...
				$('#question' + j + '_ap_question_text').attr("value", questions[j]['questiontext']);
				$('#question' + j + '_ap_question_score').attr("value", +questions[j]['score']);
				...
				if(type === 0) { // Regular test
					...
					$('#question' + j + '_ap_answer_correct').attr("value", questions[j]['answer0']);
					$('#question' + j + '_ap_answer_incorrect0').attr("value", questions[j]['answer1']);
					$('#question' + j + '_ap_answer_incorrect1').attr("value", questions[j]['answer2']);
					$('#question' + j + '_ap_answer_incorrect2').attr("value", questions[j]['answer3']);
					...
					// Answers text
					$('#question' + j + '_ap_answer0').attr("value", questions[j]['answer0']);
					$('#question' + j + '_ap_answer1').attr("value", questions[j]['answer1']);
					$('#question' + j + '_ap_answer2').attr("value", questions[j]['answer2']);
					$('#question' + j + '_ap_answer3').attr("value", questions[j]['answer3']);
					// Checkboxes
					...
					$('#question' + j + '_ap_gapword').attr("value", questions[j]['answer0']);
